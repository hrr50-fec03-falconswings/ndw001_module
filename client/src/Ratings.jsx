...
class Ratings extends React.Component{
  ...
  render(){
    if (this.props.rating < 0.3) {
      ...
      } else if (this.props.rating >= 0.3 && this.props.rating < 0.7) {
        return (
          <div>
      ...
      } else if ( this.props.rating >= 0.7 && this.props.rating < 1.4 ) {
        return (
          <div>
      ...
      } else if ( this.props.rating >= 1.7 && this.props.rating < 2.4 ) {
        return (
          <div>
            <FontAwesomeIcon id='star1'icon={solid.faStar}/>
      ...
      } else if ( this.props.rating >= 2.7 && this.props.rating < 3.4 ) {
        return (
          <div>
            <FontAwesomeIcon id='star1'icon={solid.faStar}/>
            <FontAwesomeIcon id='star2'icon={solid.faStar}/>
      ...
      } else if ( this.props.rating >= 3.7 && this.props.rating < 4.4 ) {
        return (
          <div>
            <FontAwesomeIcon id='star1'icon={solid.faStar}/>
            <FontAwesomeIcon id='star2'icon={solid.faStar}/>
